...
class EvolutionarySolverConfig(SolverConfig):
    ...
    selector: Optional[SelectorConfig] = field(
        default=None,
        metadata={
            "description": "Node selection strategy configuration. If None, defaults to fitness-based selection.",
            "help": "Use selector=fitness for original behavior, selector=rlm for intelligent selection.",
        },
    )
