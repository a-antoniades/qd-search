...
class Hyperparameters:
    ...
    total_batch_size = 16384 # total desired batch size, in units of #tokens (16*1024*1 for 1-GPU debug)
    ...
    val_tokens = 655360 # how many tokens of validation data (10 val batches for debug)
...
if __name__ == "__main__":
    ...
    print0("skipping torch.compile for debug (too slow)...")
    model = model.cuda()
    ...
    for step in range(args.num_iterations + 1):
        ...
        if ((args.val_loss_every > 0 and step > 0 and step % args.val_loss_every == 0) or last_step) \
